    ...
    return (
        ...
        <div style={{display: "flex", width:'100%'}}>  
            <div style={{display: "flex", gap: '20px',width:'100%'}}>
                ...
                <button style={{width: 'fit-content'}}><a href="../Lab 3/Завдання 1/index.html">Завдання №1. Зовнішній вигляд макету. Код макету</a></button>
                <button style={{width: 'fit-content'}}>Завдання №2</button>
                <a href="../Lab 3/Завдання 2.1/index.html">Фіксована таблична верстка</a>
                <a href="../Lab 3/Завдання 2.2/index.html">Гумова таблична верстка</a>
                <a href="../Lab 3/Завдання 2.3/index.html">Фіксована блокова верстка</a>
                <a href="../Lab 3/Завдання 2.4/index.html">Гумова блокова верстка</a>
                ...
                <div style={{display: "flex", width:'990px'}}>
                    ...
                    <div style={{width:'100%'}}>
                        ...
                        <img src="lab3/res.png" style={{ objectFit:'none'}}/>
                    </div>
                    }
                    {tab === 3 &&
                    <div style={{width:'100%'}}>
